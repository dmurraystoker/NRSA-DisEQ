---
title: "Environmental filtering and habitat matchinging of riverine invertebrate communities"
...
#load("data_analysis/2-DisEQ_analyses/2-DisEQ_analyses-Workspace.RData")
...
knitr::include_graphics(paste0(getwd(), "/figures/Figure_2-filtering_mismatch_ANOVAs-final.jpg"))
```
...
trait.diversity <- data.frame(dbFD(
...
knitr::include_graphics(paste0(getwd(), "/figures/Figure_3-trait_diversity-final.jpg"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/Figure_4-filtering_by_traits-final.jpg"))
```

\newpage

```{r Habitat Matching-by-Trait Figure, echo = FALSE, fig.cap = "Facet plot of habitat matching-by-trait relationships."}
knitr::include_graphics(paste0(getwd(), "/figures/Figure_5-mismatch_by_traits-final.jpg"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/Figure_6-traits_by_environment-final.jpg"))
```
...
save.image("data_analysis/2-DisEQ_analyses/2-DisEQ_analyses-Workspace.RData")
```
...
save.image("data_analysis/2-DisEQ_analyses/2-DisEQ_analyses-Reduced_Workspace.RData")
```
