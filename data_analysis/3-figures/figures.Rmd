...
final.data$ecoregion <- fct_relevel(
	...
	c("WMT", "XER", "NPL", "SPL", "TPL", "UMW", "NAP", "SAP", "CPL")
	)
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_1-site_map-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_2-filtering_mismatch_ANOVAs-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_S1-vector_components-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_3-trait_diversity-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_4-filtering_by_traits-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_5-mismatch_by_traits-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_6-traits_by_environment-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_S2-filtering_by_trait_diversity-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_S3-mismatch_by_trait_diversity-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/base/figure_S4-DisEQ_regression-base.pdf"))
```
...
knitr::include_graphics(paste0(getwd(), "/figures/edited/figure_S5-community_composition.pdf"))
```
